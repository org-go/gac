...
func CalcDayNum(start time.Time, end time.Time) (int, error) {
...
// Time_RencentRangeDate 获取最近几天日期的开始日期与结束日期
//func Time_RencentRangeDate(n int) (time.Time, string) {
