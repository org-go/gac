...
// @Router /admin/service_permission/create [POST]
func (a *ServicePermissionApi) Create(c *gin.Context) {
...
// @Failure 400 {object}  Response
// @Failure 500 {object}  Response
// @Router /admin/service_permission/query [POST]
func (a *ServicePermissionApi) Query(c *gin.Context) {
...
// @Failure 400 {object}  Response
// @Failure 500 {object}  Response
// @Router /admin/service_permission/menus [POST]
func (a *ServicePermissionApi) Menus(c *gin.Context) {
