...
type StaffPermissionApi struct{}
...
// @Router /admin/staff_permission/create [POST]
func (a *StaffPermissionApi) Create(c *gin.Context) {
...
// @Failure 400 {object}  Response
// @Failure 500 {object}  Response
// @Router /admin/staff_permission/query [POST]
func (a *StaffPermissionApi) Query(c *gin.Context) {
...
// @Failure 400 {object}  Response
// @Failure 500 {object}  Response
// @Router /admin/staff_permission/menus [POST]
func (a *StaffPermissionApi) Menus(c *gin.Context) {
